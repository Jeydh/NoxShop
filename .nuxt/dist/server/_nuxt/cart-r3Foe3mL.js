import { u as useCartStore, b as useCatalogStore, a as __nuxt_component_0, c as useCurrency } from "../server.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (cartLines.value.length === 0) {
        _push(`<div class="mt-10 rounded-3xl border border-white/10 bg-white/[0.03] px-6 py-16 text-center"><div class="text-5xl"> 🛒 </div><h2 class="mt-5 text-xl font-black text-white"> Votre panier est vide </h2><p class="mx-auto mt-2 max-w-sm text-sm leading-6 text-slate-400"> Ajoutez quelques produits et votre commande apparaîtra ici. </p>`);
        _push(ssrRenderComponent(_component_NuxtLink, {
          to: "/products",
        ...
        _push(`<p class="mt-3 text-center text-[11px] leading-5 text-slate-600"> Votre commande sera préparée avant votre arrivée. </p></aside></div>`);
      }
      _push(`</div>`);
    };
  }
...
//# sourceMappingURL=cart-r3Foe3mL.js.map
