...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-black">Équipe</h1><p class="mt-1 text-sm text-slate-500">Comptes et permissions mockés.</p><div class="mt-6 grid gap-4 md:grid-cols-2 xl:grid-cols-3"><!--[-->`);
...
//# sourceMappingURL=team-C_1RHXrQ.js.map
