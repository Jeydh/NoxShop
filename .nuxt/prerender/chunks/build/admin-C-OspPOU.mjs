...
import { defineComponent, computed, mergeProps, withCtx, createVNode, createTextVNode, unref, toDisplayString, useSSRContext } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrInterpolate, ssrRenderList, ssrRenderSlot } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/server-renderer/index.mjs';
import { r as roleLabels } from './users-CW0tpuyF.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const items = [
      ...
      { label: "\xC9quipe", to: "/admin/team", permission: "team.manage" }
    ];
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<button class="rounded-xl bg-slate-900 px-3 py-2 text-xs font-semibold text-white">D\xE9connexion</button></div></div></header><div class="mx-auto flex max-w-[1500px]"><aside class="hidden w-60 shrink-0 border-r border-slate-200 bg-white p-4 md:block"><nav class="space-y-1"><!--[-->`);
...
//# sourceMappingURL=admin-C-OspPOU.mjs.map
