import { u as useCartStore, a as __nuxt_component_0$1 } from './server.mjs';
import { defineComponent, mergeProps, withCtx, createVNode, unref, createTextVNode, Transition, openBlock, createBlock, toDisplayString, createCommentVNode, ref, computed, useSSRContext } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderClass, ssrInterpolate, ssrRenderSlot } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/server-renderer/index.mjs';
...
const useShopStatus = () => {
  ...
  const statusText = computed(() => isOpen.value ? "Ouvert \u2014 ferme \xE0 02h00" : "Ferm\xE9 \u2014 ouvre demain \xE0 08h00");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`</main><footer class="border-t border-white/5 py-10 text-center text-xs text-slate-500"> \xA9 2026 Nox \xB7 D\xE9monstration \xB7 `);
      _push(ssrRenderComponent(_component_NuxtLink, {
        to: "/admin",
        class: "relative rounded-2xl border border-white/10 bg-white/5 p-2.5 transition hover:scale-105 hover:bg-white/10"
      }, {
...
//# sourceMappingURL=default-ohWUb2zL.mjs.map
