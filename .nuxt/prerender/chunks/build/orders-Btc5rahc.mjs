import { _ as _sfc_main$1 } from './OrderStatusBadge-CXF5wSxY.mjs';
import { defineComponent, unref, useSSRContext } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrInterpolate, ssrRenderComponent } from 'file:///home/jeydh/projects/nox-shop/node_modules/vue/server-renderer/index.mjs';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const actionLabel = (status) => ({ pending: "Commencer", preparing: "Marquer pr\xEAte", ready: "Remettre au client", completed: "Termin\xE9e", cancelled: "Annul\xE9e" })[status];
    return (_ctx, _push, _parent, _attrs) => {
      const _component_OrderStatusBadge = _sfc_main$1;
      _push(`<div${ssrRenderAttrs(_attrs)}><h1 class="text-3xl font-black">Commandes</h1><p class="mt-1 text-sm text-slate-500">Pr\xE9paration et suivi des retraits.</p><div class="mt-6 grid gap-4"><!--[-->`);
      ssrRenderList(unref(orders), (order) => {
        _push(`<div class="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm"><div class="flex flex-wrap items-center justify-between gap-3"><div><strong>${ssrInterpolate(order.id)}</strong><p class="mt-1 text-sm text-slate-500">${ssrInterpolate(order.customerName)} \xB7 ${ssrInterpolate(order.phone)}</p></div>`);
...
//# sourceMappingURL=orders-Btc5rahc.mjs.map
